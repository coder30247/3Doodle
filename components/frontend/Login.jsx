        ...
        <div className="min-h-screen bg-[#fff8ed] relative flex flex-col items-center justify-center">
            ...
            <div className="bg-white rounded-2xl shadow-lg px-12 py-10 flex flex-col items-center min-w-[350px]">
                ...
                <div className="flex w-full justify-center mb-6">
                    <button className="px-6 py-1 text-xl font-semibold rounded-t-xl border border-b-0 border-black bg-white text-black">
                        SIGN-UP
                    </button>
                    <button className="px-6 py-1 text-xl font-semibold rounded-t-xl bg-teal-400 text-white border border-b-0 border-black -ml-px">
                        LOGIN
                    </button>
                    <button className="px-6 py-1 text-xl font-semibold rounded-t-xl border border-b-0 border-black bg-white text-black -ml-px">
                        GUEST
                    </button>
                </div>
                {/* Form */}
